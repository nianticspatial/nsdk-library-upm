Shader "Unlit/NsdkPlaybackBackground"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "AR Camera Background (Nsdk)"
            Cull Off
            ZWrite On
            ZTest Always
            Lighting Off
            ...
            #pragma multi_compile_local __ NSDK_ENVIRONMENT_DEPTH_ENABLED
...
#if NSDK_ENVIRONMENT_DEPTH_ENABLED
            // Depth image
...
#endif // NSDK_ENVIRONMENT_DEPTH_ENABLED
