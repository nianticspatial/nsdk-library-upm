...
namespace NianticSpatial.NSDK.AR.Editor.SceneSegmentation
{
    [CustomEditor(typeof(ARSceneSegmentationManager))]
    internal class ARSceneSegmentationManagerEditor : UnityEditor.Editor
    {
