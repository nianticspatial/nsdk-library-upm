...
namespace NianticSpatial.NSDK.AR.Editor.PersistentAR
{
        ...
        UnityEditor.Editor
    {
        ...
        private NsdkVpsUsageUtility.NsdkVpsUsageMode _previousVpsUsageMode;
        ...
        private void DrawFields()
        {
            ...
            var usageMode = (NsdkVpsUsageUtility.NsdkVpsUsageMode)_VpsUsageMode.intValue;
            ...
            {
                _VpsUsageMode.intValue = (int)NsdkVpsUsageUtility.NsdkVpsUsageMode.Custom;
                _previousVpsUsageMode = NsdkVpsUsageUtility.NsdkVpsUsageMode.Custom;
            }
        ...
        private void ApplyNewVpsUsageMode(NsdkVpsUsageUtility.NsdkVpsUsageMode usageMode)
        {
            if (usageMode == NsdkVpsUsageUtility.NsdkVpsUsageMode.Custom)
            {
                return;
            }

            if (usageMode == NsdkVpsUsageUtility.NsdkVpsUsageMode.Default)
            {
                usageMode = NsdkVpsUsageUtility.NsdkVpsUsageMode.SingleLocalization;
            }

            var config = NsdkVpsUsageUtility.CreateConfiguration(usageMode);
        ...
        protected void OnEnable()
        {
            ...
            _previousVpsUsageMode = (NsdkVpsUsageUtility.NsdkVpsUsageMode)_VpsUsageMode.intValue;
