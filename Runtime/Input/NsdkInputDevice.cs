...
{
    internal abstract class NsdkInputDevice : InputDevice
    {
        private const string InterfaceName = "Nsdk-Input-Device";
        private const string Manufacturer = "Niantic Spatial";
        ...
        public static void AddDevice<T>(string productName) where T : NsdkInputDevice, new()
        {
        ...
        public static void RemoveDevice<T>() where T : NsdkInputDevice, new()
        {
    ...
    internal struct NsdkInputState : IInputStateTypeInfo
    {
        // FourCC stands for Niantic Spatial Input Device
        private static FourCC Format => new('N', 'S', 'I', 'D');
