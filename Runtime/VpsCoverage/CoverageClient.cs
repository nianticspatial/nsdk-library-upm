...
namespace NianticSpatial.NSDK.AR.VpsCoverage
{
    ...
    public class CoverageClient
    {
        ...
        public CoverageClient(NsdkSettings nsdkSettings)
        {
            _coverageAreasEndpoint = nsdkSettings.VpsCoverageEndpoint + BasePath + CoverageAreasMethodName;
            _localizationTargetsEndpoint = nsdkSettings.VpsCoverageEndpoint + BasePath + LocalizationTargetMethodName;
        }

        public CoverageClient()
        {
            var endpointSettings = NsdkSettingsHelper.ActiveSettings.EndpointSettings;
