...
namespace NianticSpatial.NSDK.AR.Common
{
    internal static class ImageConversionUtils
    {
        ...
        {
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_Image_TryConvert")]
            ...
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_Image_GetConvertedDataSize")]
