...
namespace NianticSpatial.NSDK.AR.Utilities.Logging
{
    internal static class Log
    {
        ...
        internal static void ConfigureLogger(IntPtr unityContextHandle, LogLevel unityLogLevel, LogLevel fileLogLevel, LogLevel stdoutLogLevel)
        {
            ...
            NsdkUnityContext.OnDeinitialized += SwitchBackToDefaultUnityLogger;
        ...
        /// <returns>A string with the full name of the calling class, or "Niantic.NSDK" if reflection fails</returns>
        private static (string fullName, string methodName) GetCallerFromStack(int nestedLevel)
        {
            ...
            return caller == null ? ("Niantic.NSDK", string.Empty) : (caller.FullName, methodName);
        }
