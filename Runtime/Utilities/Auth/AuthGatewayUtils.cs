...
namespace NianticSpatial.NSDK.AR.Utilities.Auth
{
    /// <summary>
    ...
    internal class AuthGatewayUtils : IAuthGatewayUtils
    {
        ...
        /// <summary>
        /// Returns a string representation of the time left until the token expires.
        /// </summary>
        /// <param name="expiresAt">The expiry time of the token.</param>
        /// <param name="currentTimeSeconds">The current time in seconds.</param>
        /// <returns>A string representation of the time left until the token expires.</returns>
        public static string GetTimeLeftString(int expiresAt, int currentTimeSeconds)
        {
