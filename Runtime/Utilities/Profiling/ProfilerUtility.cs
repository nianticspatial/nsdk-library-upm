...
//#define NIANTICSPATIAL_NSDK_FAST_MEMORY_PROFILER
...
#else
        [Conditional("ENABLE_NSDK_PROFILER")]
        public static void RegisterProfiler(IProfiler profiler)
        {
