...
namespace NianticSpatial.NSDK.AR.Utilities
{
    ...
    ///   PrioritizingEvent.AddListener for more). But this class is internal and NSDK will never do anything
    ...
    {
        internal static string s_gameObjectName = "__nsdk_ar_monobehaviour_event_dispatcher__";
        ...
        // There are no current use cases like this in NSDK, so we're leaving this class as is for now.
        ...
        private void OnDestroy()
        {
            ...
            if (!_destroyedValidly && gameObject.scene.isLoaded)
            {
                ...
                (
                    ...
                    "This will severely limit NSDK functionality until the XR loader is re-initialized " +
