...
namespace NianticSpatial.NSDK.AR.Utilities
{
    ...
    public static class XRDisplayContext
    {
        ...
        /// </summary>
        /// <returns>The corrected screen orientation. When running XR in NSDK's Playback mode, the
        ...
        {
#if !UNITY_EDITOR && UNITY_ANDROID && (NIANTICSPATIAL_NSDK_SPACES_ENABLED || NIANTICSPATIAL_NSDK_ML2_ENABLED || NIANTICSPATIAL_NSDK_META_ENABLED)
            ...
            if (XRGeneralSettings.Instance != null
                ...
                && XRGeneralSettings.Instance.Manager.activeLoader.GetLoadedSubsystem<XRSessionSubsystem>()
                    is NsdkPlaybackSessionSubsystem)
            {
