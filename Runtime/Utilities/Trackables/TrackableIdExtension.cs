...
namespace NianticSpatial.NSDK.AR.Utilities
{
    public static class TrackableIdExtension
    {
        ...
        // Formats a trackableId into a string that is compatible with NSDK's native components
        ...
        public static string ToNsdkHexString(this TrackableId trackableId)
        {
        ...
        {
            var gotTrackableIdComponents = NsdkHexStringToUlongs(uuid, out var upper, out var lower);
        ...
        public static bool NsdkHexStringToUlongs(string hexString, out ulong upper, out ulong lower)
        {
