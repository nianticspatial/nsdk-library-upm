...
namespace NianticSpatial.NSDK.AR.Simulation
{
    ...
    /// </summary>
    internal readonly struct NsdkCameraTextureFrameEventArgs
    {
        public NsdkCameraTextureFrameEventArgs(long timestampNs, Matrix4x4 projectionMatrix, Matrix4x4 displayMatrix, XRCameraIntrinsics intrinsics, Texture2D texture)
        {
