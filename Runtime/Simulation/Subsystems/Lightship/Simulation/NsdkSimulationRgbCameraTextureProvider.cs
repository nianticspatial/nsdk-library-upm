...
{
    internal class NsdkSimulationRgbCameraTextureProvider : NsdkSimulationTextureProvider
    {
        protected override int PropertyNameId => NsdkSimulationCameraSubsystem.s_textureSinglePropertyNameId;
