...
{
    [Preserve]
    public class NsdkPlaybackOcclusionSubsystem : XROcclusionSubsystem, IPlaybackDatasetUser
    {
        /// <summary>
        ...
        internal Matrix4x4? LatestIntrinsicsMatrix
        {
            get
            {
                if (provider is NsdkPlaybackProvider nsdkProvider)
                {
        ...
        private class NsdkPlaybackProvider : Provider, IPlaybackDatasetUser
        {
            ...
            {
                Log.Info("NsdkPlaybackOcclusionSubsystem.NsdkPlaybackProvider construct");
            ...
            public override bool TryAcquireEnvironmentDepthConfidenceCpuImage(out XRCpuImage.Cinfo cinfo)
            {
                ...
                var cpuImageApi = (NsdkCpuImageApi)environmentDepthConfidenceCpuImageApi;
