...
{
    [Preserve]
    internal class NsdkPlaybackInputProvider : NsdkInputProvider, IPlaybackDatasetUser
    {
        private PlaybackDatasetReader _datasetReader;

        public NsdkPlaybackInputProvider() : base()
        {
            NsdkInputDevice.AddDevice<PlaybackInputDevice>(PlaybackInputDevice.ProductName);
        }
    ...
    [InputControlLayout(
        stateType = typeof(NsdkInputState),
        displayName = ProductName)]
    internal sealed class PlaybackInputDevice : NsdkInputDevice
    {
        public const string ProductName = "NsdkPlaybackCamera";
    }
}
