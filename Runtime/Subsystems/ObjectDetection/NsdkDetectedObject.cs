...
using CategoryDirectory = NianticSpatial.NSDK.AR.Subsystems.ObjectDetection.NsdkObjectDetectionSubsystem.NsdkObjectDetectionProvider.CategoryDirectory;
using DisplayHelper = NianticSpatial.NSDK.AR.Subsystems.ObjectDetection.NsdkObjectDetectionSubsystem.NsdkObjectDetectionProvider.DisplayHelper;

namespace NianticSpatial.NSDK.AR.Subsystems.ObjectDetection
{
    internal class NsdkDetectedObject : XRDetectedObject
    {
