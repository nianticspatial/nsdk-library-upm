...
{
    /// <summary>
    /// NSDK's version of ARFoundation's ARTextureInfo.
    /// It is used for surfacing external (native) textures provided by NSDK AR subsystems.
    /// </summary>
    internal abstract class NsdkExternalTexture : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Factory method to create a NsdkExternalTexture from a XRTextureDescriptor.
        /// </summary>
        ...
        /// </param>
        /// <returns>A NsdkExternalTexture instance.</returns>
        /// <exception cref="NotSupportedException">Thrown if the texture descriptor is not supported.</exception>
        public static NsdkExternalTexture Create(XRTextureDescriptor descriptor, bool useLinearColorSpace = false)
        {
        ...
        /// <summary>
        /// Creates or updates a NsdkExternalTexture based on the provided descriptor.
        /// </summary>
        /// <param name="texture">The NsdkExternalTexture to create or update.</param>
        /// <param name="descriptor">The texture descriptor.</param>
        public static bool CreateOrUpdate(ref NsdkExternalTexture texture, XRTextureDescriptor descriptor)
        {
            if (texture == null)
            {
