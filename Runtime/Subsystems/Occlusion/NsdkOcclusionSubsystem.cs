...
namespace NianticSpatial.NSDK.AR.Subsystems.Occlusion
{
    ...
    public sealed class NsdkOcclusionSubsystem : XROcclusionSubsystem
    {
        ...
        public uint TargetFrameRate
        {
            get
            {
                if (provider is NsdkOcclusionProvider nsdkProvider)
                {
                    return nsdkProvider.TargetFrameRate;
                }
            ...
            set
            {
                if (provider is NsdkOcclusionProvider nsdkProvider)
                {
                    nsdkProvider.TargetFrameRate = value;
                }
            }
        }
        ...
        internal bool RequestDisableFetchTextureDescriptors
        {
            get
            {
                if (provider is NsdkOcclusionProvider nsdkProvider)
                {
                    return nsdkProvider.RequestDisableFetchTextureDescriptors;
                }
            ...
            set
            {
                if (provider is NsdkOcclusionProvider nsdkProvider)
                {
                    nsdkProvider.RequestDisableFetchTextureDescriptors = value;
                }
            }
        }
        ...
        public Matrix4x4? LatestExtrinsicsMatrix
        {
            get
            {
                if (provider is NsdkOcclusionProvider nsdkProvider)
                {
                    return nsdkProvider.LatestExtrinsicsMatrix;
                }
        ...
        {
            if (provider is NsdkOcclusionProvider lsProvider)
            {
        ...
        /// <summary>
        /// Register the NSDK occlusion subsystem.
        /// </summary>
        ...
        /// </summary>
        internal class NsdkOcclusionProvider : Provider
        {
            /// <summary>
            ...
            /// <summary>
            /// The shader keyword for enabling environment depth rendering for NSDK Playback Background shader.
            /// </summary>
            /// <value>
            /// The shader keyword for enabling environment depth rendering.
            /// </value>
            private const string _EnvironmentDepthEnabledNsdkMaterialKeyword =
            ...
            private static readonly List<string> _environmentDepthEnabledMaterialKeywords =
                new()
                {
                    ...
                    _EnvironmentDepthEnabledNsdkMaterialKeyword
                };
            ...
            public NsdkOcclusionProvider() : this(new NativeApi()) { }

            /// <summary>
            /// Construct the implementation provider.
            /// </summary>
            public NsdkOcclusionProvider(IApi api)
            {
                _api = api;
            ...
            private byte UnityModeToNsdkMode(EnvironmentDepthMode mode)
            {
                switch (mode)
                {
            ...
            private void ConfigureProvider()
            {
                ...
                (
                    ...
                    UnityModeToNsdkMode(requestedEnvironmentDepthMode),
                    TargetFrameRate
                );
            ...
            public override bool TryAcquireEnvironmentDepthCpuImage(out XRCpuImage.Cinfo cinfo)
            {
                ...
                var cpuImageApi = (NsdkCpuImageApi)environmentDepthCpuImageApi;
