...
namespace NianticSpatial.NSDK.AR.Subsystems.Occlusion
{
    internal class NativeApi : IApi
    {
        ...
        public bool TryGetLatestExtrinsicsMatrix(IntPtr nativeProviderHandle, out Matrix4x4 extrinsicsMatrix)
        {
            ...
            extrinsicsMatrix = extrinsics.FromColumnMajorArray().FromNsdkToUnity();
            return true;
        }
        ...
        {
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_Construct")]
            public static extern IntPtr Construct(IntPtr unityContext);

            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_Start")]
            public static extern void Start(IntPtr depthApiHandle);

            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_Stop")]
            public static extern void Stop(IntPtr depthApiHandle);

            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_Configure")]
            public static extern void Configure(IntPtr depthApiHandle, byte mode, uint frameRate);

            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_Destruct")]
            public static extern void Destruct(IntPtr depthApiHandle);

            /// Returns the ExternalHandle to the memoryBuffer
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_GetEnvironmentDepth")]
            ...
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_Blit")]
            ...
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_TryGetLatestIntrinsics")]
            public static extern bool TryGetLatestIntrinsics(IntPtr nativeProviderHandle, float[] intrinsics);

            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_TryGetLatestExtrinsics")]
            public static extern bool TryGetLatestExtrinsics(IntPtr nativeProviderHandle, float[] extrinsics);

            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_TryGetLatestEnvironmentDepthResolution")]
            ...
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_CalculateSamplerMatrix")]
            ...
            [DllImport(NsdkPlugin.Name, EntryPoint = "Lightship_ARDK_Unity_OcclusionProvider_ReleaseResource")]
