...
namespace NianticSpatial.NSDK.AR.XRSubsystems
{
            ...
            ISubsystemWithModelMetadata
    {
        ...
        /// <summary>
        /// Is true if the object detection category names can be acquired.
        /// </summary>
        /// <value>
        /// If category names are available.
        /// </value>
        ...
        public bool IsMetadataAvailable
        {
            get
            {
                return provider.TryGetCategoryNames(out IReadOnlyList<string> _);
            }
        }
