...
namespace NianticSpatial.NSDK.AR.XRSubsystems
{
    ...
    /// </summary>
    [PublicAPI]
    public class XRSceneSegmentationSubsystem
        : SubsystemWithProvider<XRSceneSegmentationSubsystem, XRSceneSegmentationSubsystemDescriptor, XRSceneSegmentationSubsystem.Provider>,
            ISubsystemWithModelMetadata
    {
        ...
        /// texture.</exception>
        public bool TryGetSceneSegmentationChannel(SceneSegmentationChannel channel, out XRTextureDescriptor sceneSegmentationChannelDescriptor, out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            => provider.TryGetSceneSegmentationChannel(channel, out sceneSegmentationChannelDescriptor, out samplerMatrix, cameraParams);
        ...
        {
            return provider.TryAcquireSceneSegmentationChannelCpuImage(channel, out cpuImage, out samplerMatrix, cameraParams);
        }
        ...
        /// texture.</exception>
        public bool TryGetPackedSceneSegmentationChannels(out XRTextureDescriptor packedSceneSegmentationDescriptor, out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            => provider.TryGetPackedSceneSegmentationChannels(out packedSceneSegmentationDescriptor, out samplerMatrix, cameraParams);
        ...
        public bool TryAcquirePackedSceneSegmentationChannelsCpuImage(out XRCpuImage cpuImage, out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            => provider.TryAcquirePackedSceneSegmentationChannelsCpuImage(out cpuImage, out samplerMatrix, cameraParams);
        ...
        /// </summary>
        /// <param name="sceneSegmentationSubsystemCinfo">The semantics subsystem implementation construction information.
        /// </param>
        /// <returns>
        /// <c>true</c> if the descriptor was registered. Otherwise, <c>false</c>.
        /// </returns>
        public static bool Register(XRSceneSegmentationSubsystemCinfo sceneSegmentationSubsystemCinfo)
        {
            var sceneSegmentationSubsystemDescriptor = XRSceneSegmentationSubsystemDescriptor.Create(sceneSegmentationSubsystemCinfo);
            SubsystemDescriptorStore.RegisterDescriptor(sceneSegmentationSubsystemDescriptor);
            return true;
        }
        ...
        public HashSet<SceneSegmentationChannel> SuppressionMaskChannels
        {
        ...
        public IReadOnlyList<SceneSegmentationChannel> GetChannels() => provider.GetChannels();
        ...
        /// <summary>
        /// The provider which will service the <see cref="XRSceneSegmentationSubsystem"/>.
        /// </summary>
        public abstract class Provider : SubsystemProvider<XRSceneSegmentationSubsystem>
        {
            ...
            /// <exception cref="System.NotSupportedException">Thrown if the implementation does not support semantics channel
            /// texture.</exception>
            public virtual bool TryGetSceneSegmentationChannel(SceneSegmentationChannel channel, out XRTextureDescriptor sceneSegmentationChannelDescriptor, out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            ...
            /// Thrown if the implementation does not support semantic channels CPU images.
            /// </exception>
            public virtual bool TryAcquireSceneSegmentationChannelCpuImage(SceneSegmentationChannel channel, out XRCpuImage cpuImage,  out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            ...
            /// <exception cref="System.NotSupportedException">Thrown if the implementation does not support packed semantics
            /// texture.</exception>
            public virtual bool TryGetPackedSceneSegmentationChannels(out XRTextureDescriptor packedSceneSegmentationDescriptor, out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            ...
            /// Returns `true` if an <see cref="XRCpuImage"/> was successfully acquired. Returns `false` otherwise.
            /// </returns>
            public virtual bool TryAcquirePackedSceneSegmentationChannelsCpuImage(out XRCpuImage cpuImage, out Matrix4x4 samplerMatrix, XRCameraParams? cameraParams = null)
            ...
            public virtual HashSet<SceneSegmentationChannel> SuppressionMaskChannels
            {
                get => new();
                set
                {
            ...
            /// supported by the implementation.</exception>
            /// <returns>True if the threshold was set. Otherwise, false.</returns>
            public virtual bool TrySetChannelConfidenceThresholds(Dictionary<SceneSegmentationChannel, float> channelConfidenceThresholds)
