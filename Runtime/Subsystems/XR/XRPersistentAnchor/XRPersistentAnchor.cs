...
namespace NianticSpatial.NSDK.AR.XRSubsystems
{
    ...
    public struct XRPersistentAnchor : ITrackable, IEquatable<XRPersistentAnchor>
    {
        ...
        public XRPersistentAnchor(TrackableId trackableId, bool initializing)
        {
            m_Id = trackableId;
            m_Pose = Pose.identity;
            m_TrackingState = TrackingState.None;
            m_TrackingStateReason = initializing ? TrackingStateReason.Initializing : TrackingStateReason.None;
            m_TrackingConfidence = 0.0f;
            m_XRPersistentAnchorPayload = new XRPersistentAnchorPayload(new IntPtr(0), 0);
            m_timestampMs = 0;
        }
        ...
        /// </summary>
        [Obsolete("When using the XRVps2Subsystem, call GetAnchorPayload instead.")]
