...
namespace NianticSpatial.NSDK.AR.Subsystems.SceneSegmentation
{
    internal class MockApi : IApi
    {
        ...
        private readonly BufferedTextureCache _packedSceneSegmentationBufferedTextureCache = new(TextureBufferSize);
        ...
        )
        {
            ...
            unsafe
            {
                ...
                sceneSegmentationChannelDescriptor =
        ...
        )
        {
            ...
            unsafe
            {
                ...
                var tex = _packedSceneSegmentationBufferedTextureCache.GetUpdatedTextureFromBuffer
                (
                    nativePtr,
                ...
                packedSceneSegmentationDescriptor =
                    new XRTextureDescriptor
                    (
                        tex.GetNativeTexturePtr(),
                        _width,
        ...
        {
            var semanticChannels = new List<SceneSegmentationChannel>(AllChannels);
        ...
        private void InitializePackedBuffer(List<SceneSegmentationChannel> semanticChannels)
        {
