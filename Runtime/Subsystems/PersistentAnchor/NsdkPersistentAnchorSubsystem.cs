...
{
    /// <summary>
    /// The NSDK implementation of the <c>XRPersistentAnchorSubsystem</c>. Do not create this directly.
    /// Use the <c>SubsystemManager</c> instead.
    /// </summary>
    [Preserve]
    public sealed class NsdkPersistentAnchorSubsystem : XRPersistentAnchorSubsystem, ISubsystemWithMutableApi<IApi>
    {
        internal class NsdkProvider : Provider
        {
            ...
            {
                Log.Info("NsdkPersistentAnchorSubsystem.NsdkProvider construct");
                _api = api;
#if NIANTICSPATIAL_NSDK_AR_LOADER_ENABLED
                _nativeProviderHandle = _api.Construct(NsdkUnityContext.UnityContextHandle);
#endif
                Log.Info("NsdkPersistentAnchorSubsystem got _nativeProviderHandle: " + _nativeProviderHandle);
            }
        ...
        private static void RegisterDescriptor()
        {
            ...
            {
                id = "Nsdk-PersistentAnchor",
                providerType = typeof(NsdkProvider),
                subsystemTypeOverride = typeof(NsdkPersistentAnchorSubsystem),
