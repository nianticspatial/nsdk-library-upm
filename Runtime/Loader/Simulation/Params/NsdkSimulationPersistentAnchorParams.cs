...
{
    [Serializable]
    public class NsdkSimulationPersistentAnchorParams
    {
        [SerializeField]
        ...
        internal NsdkSimulationPersistentAnchorParams() { }

        internal NsdkSimulationPersistentAnchorParams(NsdkSimulationPersistentAnchorParams source)
        {
            CopyFrom(source);
        }

        internal void CopyFrom(NsdkSimulationPersistentAnchorParams source)
        {
