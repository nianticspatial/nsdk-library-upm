...
#if NIANTICSPATIAL_NSDK_AR_LOADER_ENABLED && UNITY_ANDROID && !UNITY_EDITOR
#define NIANTICSPATIAL_NSDK_ARCORE_LOADER_ENABLED
#endif
...
namespace NianticSpatial.NSDK.AR.Loader
{
    ...
    /// </summary>
    public class NsdkARCoreLoader : ARCoreLoader, INsdkInternalLoaderSupport
    {
        ...
        //      will fail with: CameraConfigurationResult.ErrorImagesNotDispose. NSDK only holds camera
        ...
        private void UpgradeCameraConfigurationIfNeeded()
        {
            ...
            (
                ...
                "Make sure to disable unneeded features in NsdkSettings to avoid using a higher camera " +
        ...
        // preserves the previous NSDK behavior, where the first config was always used.
        ...
        {
#if NIANTICSPATIAL_NSDK_ARCORE_LOADER_ENABLED
            return base.Start();
#else
            return false;
#endif
