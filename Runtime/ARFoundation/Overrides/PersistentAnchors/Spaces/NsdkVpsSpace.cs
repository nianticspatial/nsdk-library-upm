...
namespace NianticSpatial.NSDK.AR.PersistentAnchors.Spaces
{
    ...
    /// </summary>
    [Experimental]
    public struct NsdkVpsSpaceResponse
    {
        [Experimental]
        public bool Success { get; internal set; }

        [Experimental]
        public NsdkVpsSpace Space { get; internal set; }
    ...
    /// </summary>
    [Experimental]
    public struct NsdkVpsSpace
    {
        public readonly struct NsdkVpsSpaceLabel
        {
            ...
            internal NsdkVpsSpaceLabel(MeshDownloadRequestResponse.SpaceLabel spaceLabel)
            {
        ...
        /// </summary>
        [Experimental]
        public List<NsdkVpsNode> Nodes { get; internal set; }
        ...
        /// </summary>
        [Experimental]
        public List<NsdkVpsSpaceLabel> SpaceLabels { get; internal set; }
        ...
        public readonly List<Pose> GetMeshBoundsRelativeToOrigin()
        {
            ...
            {
                if (label.Label.Equals(NsdkVpsSpaceLabel.BoundsLabel))
                {
        ...
        /// </summary>
        [Experimental]
        public static async Task<NsdkVpsSpaceResponse> GetSpaceDataForNode(string nodeId)
        {
