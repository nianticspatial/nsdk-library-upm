...
namespace NianticSpatial.NSDK.AR.Occlusion.Features
{
    ...
    internal sealed class Stabilization : RenderComponent
    {
        ...
        /// </summary>
        public const string RequiredShaderName = "Nsdk/CopyEyeDepth";
            ...
            Material externalMaterial = null)
        {
            ...
            if (_technique == NsdkOcclusionExtension.OcclusionTechnique.Automatic)
            {
            ...
            _renderPass = new OffScreenBlitPass(
                name: "NSDK Occlusion Extension (Stabilization)",
        ...
        protected override void OnUpdate(Camera camera)
        {
            ...
            Matrix4x4 pose;
            if (_technique == NsdkOcclusionExtension.OcclusionTechnique.OcclusionMesh)
            {
