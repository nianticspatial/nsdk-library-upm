...
namespace NianticSpatial.NSDK.AR.Occlusion.Features
{
    ...
    internal abstract class OcclusionComponent : RenderComponent
    {
        ...
        private NsdkExternalTexture _platformDepthTextureInfo;
        ...
        protected override void OnUpdate(Camera camera)
        {
            ...
            if (OcclusionSubsystem is NsdkOcclusionSubsystem lsSubsystem)
            {
            ...
            else if (OcclusionSubsystem != null)
            {
                if (OcclusionSubsystem.TryAcquireEnvironmentDepthCpuImage(out var image))
                {
                    ...
                    var platformTexture = GetPlatformDepthTexture();
                    GPUDepth = platformTexture == null? _tempTexture : platformTexture;
        ...
        {
            if (OcclusionSubsystem is null or NsdkOcclusionSubsystem)
            {
                return null;
            }
            ...
            {
                return NsdkExternalTexture.CreateOrUpdate(ref _platformDepthTextureInfo,
