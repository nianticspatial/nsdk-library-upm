...
namespace NianticSpatial.NSDK.AR.Occlusion.Features
{
    ...
    internal sealed class Suppression : RenderComponent
    {
        ...
        private const string KMissingSubsystemMessage = "Missing NSDK semantics subsystem reference. ";
        ...
        // Helpers
        private NsdkOcclusionExtension.OcclusionTechnique _technique;
        ...
        )
        {
            ...
            if (technique == NsdkOcclusionExtension.OcclusionTechnique.Automatic)
            {
