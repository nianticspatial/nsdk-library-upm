...
{
    public class NsdkOcclusionExtensionFeature : ScriptableRendererFeature
    {
#if MODULE_URP_ENABLED
        ...
        public override void Create()
        {
            ...
            _occlusionMeshPass = new MeshRenderingPass(
                name: "NSDK Occlusion Extension (Occlusion Mesh)",
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (currentCamera.TryGetComponent<NsdkOcclusionExtension>(out var occlusionExtension))
            {
            ...
            switch (occlusionExtension.CurrentOcclusionTechnique)
            {
                ...
                case NsdkOcclusionExtension.OcclusionTechnique.ZBuffer:
                {
                ...
                case NsdkOcclusionExtension.OcclusionTechnique.OcclusionMesh:
                {
                    if (occlusionExtension.Material != null &&
        ...
        {
            public ZBufferPass()
                : base("NSDK Occlusion Extension (ZBuffer)", RenderPassEvent.BeforeRenderingOpaques)
            {
            }
